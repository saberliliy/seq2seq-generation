...
class Seq2SeqModel:
    ...
    def build_keyword_encoder(self):
        ...
        with tf.variable_scope('encoder'):
            ...
            if self.bidirectional:
                ...
                self.encoder_cell_bw = self.build_rnn_depth_cell()
                ...
                keyword_last_state_list = [rnn.LSTMStateTuple(c=tf.concat([fw.c, bw.c], 1), h=tf.concat([fw.h, bw.h], 1))
    ...
    def predict(self, sess, content_inputs, content_inputs_length,keyword_inputs,keyword_length):
        input_feed = self.check_feeds(content_inputs, content_inputs_length,keyword_inputs,keyword_length,
